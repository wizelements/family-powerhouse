...
export const PERMISSIONS = {
  ...
  MANAGE_VENTURES: ['OWNER', 'TREASURER'],
  VIEW_VENTURE: ['OWNER', 'TREASURER', 'PLANNER', 'MEMBER', 'YOUTH'],
  
  // Habits
  CREATE_HABIT: ['OWNER', 'TREASURER', 'PLANNER', 'MEMBER', 'YOUTH'],
  MANAGE_HABITS: ['OWNER', 'TREASURER'],
  VIEW_SCOREBOARD: ['OWNER', 'TREASURER', 'PLANNER', 'MEMBER', 'YOUTH', 'GUEST'],
